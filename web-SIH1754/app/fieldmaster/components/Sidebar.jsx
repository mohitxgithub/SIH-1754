    ...
    <div className={cn("pb-12 lg:block")}>
      <div className="space-y-4 py-4">
        ...
        <div className="px-3 py-2">
          ...
          <div className="space-y-1">
            <Button variant={selectedSection === "FieldWorkers" ? "secondary" : "ghost"} className="w-full justify-start" onClick={() => handleSelect("FieldWorkers")}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-2 h-4 w-4">
        ...
        <div className="px-3 py-2">
          ...
          <div className="space-y-1">
            ...
            <Button variant={selectedSection === "Survey" ? "secondary" : "ghost"} className="w-full justify-start" onClick={() => handleSelect("Survey")}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-2 h-4 w-4">
