...
const FeaturesCard: React.FC<FeatredCardProps> = ({ icon, title, content, index }) => (
  ...
  >
    <div
      className={`w-[64px] h-[64px] rounded-full bg-[#0a0f2c] ${styles.flexCenter}`}
    >
...
const Business: React.FC = () => (
  <section id="features" className={`${layout.section}`}>
    <div className={layout.sectionInfo}>
      ...
      Transforming India Post into a leader in sustainability with data-driven insights and seamless reporting, all in one platform.
      </p>
      <Button styles="mt-10" />
    </div>
